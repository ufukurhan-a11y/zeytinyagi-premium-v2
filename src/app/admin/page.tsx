...
export default async function AdminDashboardPage() {
  ...
  const [totalOrders, newOrders, preparing, shipped, revenueAgg, recentOrders, topProducts] =
    await Promise.all([
      prisma.order.count(),
  ...
  const cards = [
    { label: "Toplam Sipariş", value: totalOrders, tone: "neutral" },
    { label: "Yeni Bekliyor", value: newOrders, tone: "amber" },
    { label: "Hazırlanıyor", value: preparing, tone: "blue" },
    { label: "Kargoda", value: shipped, tone: "green" },
    { label: "Toplam Ciro", value: fmtTL(revenueAgg), tone: "neutral" },
  ];
