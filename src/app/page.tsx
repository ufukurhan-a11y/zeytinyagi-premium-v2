          ...
          <div className="mt-10 divide-y divide-border-primary border-y border-border-primary">
            {[
              ...
              },
              {
                ...
                a: "Dedem Yusuf&apos;un altmış yıl önce diktiği fidanlarla başladı her şey. O günden bu yana üç kuşaktır aynı toprakta, aynı özenle üretiyoruz.",
              },
              {
                q: "Raf ömrü ne kadar?",
                a: "Işıktan koruyan koyu cam şişede, serin yerde 24 aya kadar tazeliğini korur.",
              },
              {
                q: "Kargo ne zaman gelir?",
                a: "Sipariş sonrası 1 iş gününde kargoya verilir, 2 iş gününde teslim edilir. Türkiye geneli ücretsiz.",
              },
            ].map((item) => (
              <details
                key={item.q}
