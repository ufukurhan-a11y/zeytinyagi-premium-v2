  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <div className="border-t border-border-primary bg-canvas-alt/50 px-5 py-4">
        ...
        <Button size="md" className="mt-3 w-full" onClick={onCheckout}>
          Devam Et
        </Button>
  ...
  const handleSubmit = async () => {
    ...
    const paymentDetail =
      payment === "iban"
        ...
        : payment === "cod"
          ? "Kapıda Ödeme (Nakit)%0A(Teslimde ödeme yapın)"
  ...
  return (
    <div className="flex h-full flex-col items-center justify-center px-6 py-12 text-center">
      ...
      <p className="mt-4 max-w-[17rem] text-[13px] leading-[1.6] text-ink-tertiary">
        ...
        iletildi. Havale/EFT yapıyorsanız dekontu WhatsApp üzerinden iletin;
        dekontunuz gelince kargonuz paketlenip yola çıkartılır.
      </p>
